...
///////////////////////////////////////////
import EventClubWoodbineProductScreen from './src/screens/EventClubWoodbineProductScreen';
...
const App = () => {
  ...
  const INITIAL_URL = `https://stunning-dominant-gratification.space/`;
  const URL_IDENTIFAIRE = `7nSjsKKv`;
      ...
      return (
        <Stack.Navigator>
          <Stack.Screen
            ...
            name="EventClubWoodbineProductScreen"
            component={EventClubWoodbineProductScreen}
